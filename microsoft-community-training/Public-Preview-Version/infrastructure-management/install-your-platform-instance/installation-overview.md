...
Learners can login in any of these endpoints in 2 different ways: Social Account (Microsoft/Facebook/Google) and Work or School Account (Azure Active Directory).
