...
[**Click here**](https://docs.microsoftcommunitytraining.com/docs/microsoft-community-training-overview) to learn more about the platform. 
...
Microsoft Community Training is available in all the countries or regions where Microsoft Azure Marketplace is commercially available. See the [**Azure Marketplace documentation**](https://docs.microsoft.com/en-us/azure/marketplace/marketplace-geo-availability-currencies) for more details.  
...
Here is [**our free content library**](https://sangampartners.azurewebsites.net/) for your reference. Also, you can host content from [**Microsoft Learn**](https://docs.microsoft.com/en-us/learn/) into the platform to provide one stop shop for all training courses to your target audience. 
...
Courses can be created from the administrator dashboard, for the detailed steps on course creation [refer to this article. ](/v1/docs/create-a-new-course)
...
For more information, check the article on [**how to manage course content**](https://docs.microsoftcommunitytraining.com/v1/docs/course-management-overview) on Microsofot Community Training platform.  
...
You can raise a request ticket via our [Helpdesk](https://sangamhelpdesk.microsoftcrmportals.com/) to request another language for your platform instance. Please refer to [this article](https://docs.microsoftcommunitytraining.com/docs/request-a-new-language) for more details.
...
For more information on analytics, check out [**this article**](https://docs.microsoftcommunitytraining.com/v1/docs/analytics-overview).

####  How to delete my training portal? 
When you no longer need your training portal, you can delete it by deleting the resource group from the Azure portal. [Refer to this article](https://docs.microsoftcommunitytraining.com/docs/delete-your-training-instance) for more details.  
