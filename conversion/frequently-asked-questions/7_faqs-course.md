...
@(Info)(Note)(You can add as many domains you want separated by comma.)
...
For detailed steps, **[refer here](https://docs.microsoftcommunitytraining.com/docs/add-practice-course-and-exam)**.
