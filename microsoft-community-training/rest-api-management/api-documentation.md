...
> [!WARNING]
> You must be signed in as an administrator on your training portal to be able to access Swagger link for your instance.
...
To obtain the access token **programmatically**, follow [this document](../rest-api-management/service-to-service-authentication.md) for **service to service authentication**.
...
>
> Once the **RefreshToken** expires, user will need to login to the instance explicitly to get new **AccessToken** and **RefreshToken** (unless you are using [S2S authentication](../rest-api-management/service-to-service-authentication.md).
>
