...
To obtain the access token **programmatically**, follow [this document](https://docs.microsoftcommunitytraining.com/v1/docs/service-to-service-authentication) for **service to service authentication**. 
...
:::(Info) (API signature to get AccessToken using RefreshToken)
```
...
Once the **RefreshToken** expires, user will need to login to the instance explicitly to get new **AccessToken** and **RefreshToken** (unless you are using [S2S authentication](https://docs.microsoftcommunitytraining.com/v1/docs/service-to-service-authentication)). 

Typically, **AccessToken** is valid for 24 hours and **RefreshToken** is valid for 90 days.
:::
## Database Schema
Refer [this document](https://docs.microsoftcommunitytraining.com/v1/docs/database-schema) to get details on the Database Schema. 
