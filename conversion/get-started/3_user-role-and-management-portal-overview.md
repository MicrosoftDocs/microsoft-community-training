...
Here are the steps on [**how to assign global administrator permission to a user**](../user-management/add-users/3_add-an-administrator-to-the-portal#add-a-global-administrator-to-the-platform)
...
Here are the steps on [**how to assign organization administrator permission to a user**](../user-management/add-users/3_add-an-administrator-to-the-portal#add-a-global-administrator-to-the-platform).
...
Here are the steps on [**how to assign Learning Path administrator permission to a user**](../content-management/manage-content/manage-learning-path/2_add-an-administrator-for-a-learning-path#steps-to-add-an-administrator-to-the-learning-path).
...
Here are the steps on [**how to assign category administrator permission to a user**](../content-management/manage-content/manage-course-category/2_add-an-administrator-for-a-course#add-a-category-administrator).
...
Here are the steps on [**how to assign course administrator permission to a user**](../content-management/manage-content/manage-course-category/2_add-an-administrator-for-a-course#add-a-course-administrator).
...
Here are the steps on [**how to assign group administrator permission to a user**](../user-management/add-users/3_add-an-administrator-to-the-portal#add-a-group-administrator-to-the-platform).
