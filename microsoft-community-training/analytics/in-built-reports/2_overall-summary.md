...
@(Info)(Note)(Hover over the column header to view the definition of the column in the table.)
...
3.	Select a row to [**view detailed information**](https://docs.microsoftcommunitytraining.com/docs/category-view-report) about course enrolments and course completion for the specific category.
