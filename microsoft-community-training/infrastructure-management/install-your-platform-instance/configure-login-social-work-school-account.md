...
1. Create a new Azure AD application by following [**this article**](/azure/active-directory/develop/quickstart-register-app). You only need to follow the section titled **Register an application**. Please ensure to set the Redirect URIs as per below:
