...
Microsoft Community Training platform leverages [**Azure Application Insights**](https://docs.microsoft.com/azure/azure-monitor/app/app-insights-overview) to capture telemetry and track aggregate traffic / usage data across all the learners on web and mobile app.  To access these data points:
