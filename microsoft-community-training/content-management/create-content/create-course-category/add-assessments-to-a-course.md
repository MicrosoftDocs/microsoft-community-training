...
1. Enter details for the **graded assessment** on the portal as below:
    ...
    * Enter **Graded Assessment Title**. The graded assessment title is the name for the assessment displayed to the learners on the web portal and mobile application. For example: *Final Exam*
